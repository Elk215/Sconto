<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1536044140,
    'editedby' => 1,
    'editedon' => 1536573301,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1536044100,
    'publishedby' => 1,
    ...
    'show_in_tree' => 1,
    'properties' => NULL,
    '_content' => '{include "file:templates/contact.tpl"}',
    '_isForward' => false,
  ),
  'contentType' => 
  array (
  ...
  array (
    '[[pdoMenu?
                    ...
                    &hereClass=`open`
                    &outerClass=`menu`]]' => '<ul class="menu"><li class="first"><a href="/">Home</a></li><li><a href="catalog">Catalog</a></li><li><a href="about-us">About us</a></li><li class="last open"><a href="contact">Contact Us</a></li></ul>',
    '[[pdoMenu?
                    &parents=`0`
                    &level=`1`
                    &resources=`1,8,6,5`
                    ...
                    &tpl=`@INLINE <li[[+classes]]><a href="[[+link]]">[[+menutitle]]</a></li>`
                    &hereClass=`open`
                    &outerClass=`mobile-menu`]]' => '<ul class="mobile-menu"><li class="first"><a href="/">Home</a></li><li><a href="catalog">Catalog</a></li><li><a href="about-us">About us</a></li><li class="last open"><a href="contact">Contact Us</a></li></ul>',
    '[[pdoCrumbs?
    &&tplWrapper=`@CODE:
        <ul class="breadcrumb">
