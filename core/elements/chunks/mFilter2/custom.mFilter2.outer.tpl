	...
	<div class="span3 col-md-3">
		...
		<div>[[%mse2_limit]]
			<select name="mse_limit" id="mse2_limit">
				<option value="5" [[+limit:is=`5`:then=`selected`]]>5</option>
				...
				<option value="1000000" [[+limit:is=`1000000`:then=`selected`]]>Показать все</option>
			</select>
		</div>
	</div>
	...
	<div class="span9 col-md-9">
		...
		<div class="row">
			<div id="mse2_sort" class="span5 col-md-6">
				...
				<a href="#" data-sort="ms|price" data-dir="[[+mse2_sort:is=``:then=`desc`]]" data-default="desc" class="sort [[+mse2_sort:is=``:then=`active`]]">[[%mse2_sort_price]] <span></span></a>
			</div>

			[[+tpls:notempty=`
			<div id="mse2_tpl" class="span4 col-md-6">
